...
//Get the categories from navbar
          ...
          <ListingHead title={listing.title} imageSrc={listing.imageSrc}
           ...
           <div className="grid grid-cols-1 md:grid-cols-7 md:gap-10 mt-6">
              <ListingInfo user={listing.user} category={category}
               description={listing.description} roomCount={listing.roomCount}
                guestCount={listing.guestCount} bathroomCount={listing.bathroomCount}
